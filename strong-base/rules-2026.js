(function(){
  ...
  const INTERVIEW_TRAINING_NOTICE = '训练改编题：依据往年回忆的形式或主题重新组织，不是原题，也不代表 2026 年会考。';
  const checked = (sourceRefs, status='needs_official_plan') => ({
    status,
    year: 2026,
    province: '江苏',
    sourceType: '用户提供的培训原稿',
    lastStructuredAt: '2026-07-12',
  ...
  const RULES = {
    meta: {
      year: 2026,
      province: '江苏',
      version: '2026.07.12-source-baseline-r2',
      schoolCount: 39,
      sourceCount: 6,
      disclaimer: '院校规则与江苏分省专业必须以学校 2026 官方招生简章、阳光高考和江苏省考试院公布信息为最终依据。',
      policy: '先核对年份、省份、选科、江苏计划、健康与语言限制，再进入策略比较。未经江苏官方核验的院校只能进入待核研究清单，不进入正式推荐；固定裸分档不参与判断。任何降分、转段或录取结果均不作保证。'
    },
    sources: [
    ...
    schools: [
      {
        ...
        fit:['basic','post-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-national'])
      },
      {
      ...
      },
      {
        ...
        riskNotes:['出分前校测存在锁档决策风险','笔面合格线在原稿中口径不一'],fit:['new-engineering','humanities','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['新工科方向可能与普通批倒挂','数学满分“小破格”不等于录取'],fit:['new-engineering','traditional-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['原稿明确称航空航天专业不对江苏招生','航空航天基础分值有 60 分/10 分冲突','出分前校测'],fit:['new-engineering','traditional-engineering','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['古文字具体语种与招生省份高度受限','必须先核江苏计划'],fit:['humanities','post-written','strict'],researchable:true,verification:checked(['source-2026-core','source-interview'])
      },
      {
        ...
        riskNotes:['江苏计划少且专业可能打包','二次选拔风险'],fit:['basic','humanities','post-written','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['色弱色盲限制','不得只为 985 层次忽视真实农学生物兴趣'],fit:['basic','post-written','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['出分前锁档风险','初试难度高','跨工科统计属于历史样本'],fit:['basic','new-engineering','humanities','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice','source-trend'])
      },
      {
        ...
        riskNotes:['出分前锁档风险','专业组和调剂后果','江苏各专业计划数需核'],fit:['basic','traditional-engineering','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice','source-trend'])
      },
      {
        ...
        riskNotes:['原稿对竞赛破格出现“仅金牌”和“银牌免初试”直接冲突','江苏计划极少','出分前校测'],fit:['new-engineering','traditional-engineering','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['动态淘汰与 AI 面试说法需核','留沪诉求可能抬高竞争'],fit:['basic','humanities','post-written','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['不同专业公式不能混用','加权成绩与最终录取公式可能不同','培养考核要求严格'],fit:['new-engineering','traditional-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['仅面试不等于不做题','加权公式易误读'],fit:['new-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['江苏本省竞争强','出分前锁档风险','专业名额与方向需按江苏计划'],fit:['new-engineering','basic','humanities','early-written','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['出分前校测','色觉与体测要求','奖牌须与专业对应'],fit:['new-engineering','basic','early-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['出分前校测','仅可填 1 个专业的原稿口径','体测要求'],fit:['new-engineering','traditional-engineering','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['色弱色盲限制','地域和长期专业接受度','非改革省公式不同'],fit:['basic','interview-only','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['仅面试可能现场做题','体测不合格风险','地域与行业路径需明确'],fit:['traditional-engineering','new-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['小破格不等于录取','仅面试可能板书做题','面试合格线'],fit:['new-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['原稿称体测任一项不合格可能淘汰，需逐字核','信息学笔试内容的专业适用范围'],fit:['new-engineering','basic','humanities','post-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['加权只适用部分专业','笔试合格线','医学生命方向长期培养'],fit:['basic','new-engineering','post-written','balanced'],researchable:true,verification:checked(['source-2026-core'])
      },
      {
        ...
        riskNotes:['新工科热度高、降分可能很小','只能报 1 个的原稿口径','小破格不等于录取'],fit:['new-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['色觉用词在不同年份由“不招”变“谨慎”，不可合并','专业接受度优先'],fit:['basic','interview-only','strict'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['当前数据不足，系统必须阻止资格判断与推荐'],fit:[],researchable:false,
        verification:{status:'blocked',year:2026,province:'江苏',sourceType:'原稿信息不足',lastStructuredAt:'2026-07-12',officialVerifiedAt:null,sourceRefs:['source-2026-core','source-national'],notice:'缺少完整 2026 条目与江苏计划，暂不可推荐。'}
      },
      {
        ...
        riskNotes:['第一志愿顺位风险','数学高分不等于直接录取','体测与本科转专业限制'],fit:['new-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['专业公式不同','面试合格线','体测和动态管理'],fit:['new-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['打包专业可能二次分流','体测与色觉要求','小破格不等于录取'],fit:['new-engineering','basic','humanities','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['计划少','色觉限制','海洋类与生物类公式不可混用'],fit:['basic','interview-only','strict'],researchable:true,verification:checked(['source-2026-core'])
      },
      {
        ...
        riskNotes:['2025 数学高分小破格与 2026 加权口径不同','密码方向数学要求高'],fit:['new-engineering','basic','post-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['第一志愿优先','加权公式分专业','地域与长期培养接受度'],fit:['traditional-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['热门王牌专业不一定降分','地域与长期发展','笔试内容待核'],fit:['new-engineering','post-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['部分专业取消江苏招生的原稿提示','仅面试可能现场解题','地域与长学制'],fit:['new-engineering','traditional-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'])
      },
      {
        ...
        riskNotes:['出分前锁档风险','数学加权适用专业不能泛化','确认与诚信条款需引用官方原文'],fit:['new-engineering','basic','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['2025/2026 入围倍数不同','物理笔试难度高','出分前校测'],fit:['new-engineering','basic','early-written','aggressive'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['出分前锁档风险','专业组名额不透明的原稿提示','缴费节点早'],fit:['new-engineering','basic','humanities','early-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['英语授课要求的适用专业需核','地域与长期深造','小破格不等于录取'],fit:['basic','humanities','post-written','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['转工比例需核源','专业组调剂','面试合格线'],fit:['new-engineering','traditional-engineering','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      },
      {
        ...
        riskNotes:['2025 提前校测与 2026 出分后口径不同','色觉限制多','地域与行业路径'],fit:['traditional-engineering','basic','interview-only','balanced'],researchable:true,verification:checked(['source-2026-core','source-choice'],'source_checked')
      }
    ],
    interviews: [
      ...
      {schoolId:'tju',formats:['多对一','三随机'],prep:'往年回忆为自我介绍后专家提问；不同专业流程可能不同',questions:['请解释足球弧线球形成的力学原理，并说明影响因素。']},
      ...
      {schoolId:'csu',formats:['一对一','站点式'],prep:'往年回忆含科学思维、创新想象、公民素质、人文素养、学科特长五个站点',questions:['如果 DNA 双螺旋结构变成直链，可能带来哪些影响？请说明推理过程。']},
      ...
      {schoolId:'nudt',formats:['多对一'],prep:'往年回忆为自我介绍后考官问答；当前 2026 流程待官方简章',questions:['请说明你更希望深入学习数学还是物理，并用一段真实经历解释原因。']},
      {schoolId:'bnu',formats:['暂无可靠来源'],prep:'六份原稿未提供可追溯的北京师范大学面试题条目，等待补充官方流程或可靠回忆。',questions:[],availability:'missing_source',sourceRefs:[]},
      {schoolId:'cau',formats:['暂无可靠来源'],prep:'六份原稿未提供可追溯的中国农业大学面试题条目，等待补充官方流程或可靠回忆。',questions:[],availability:'missing_source',sourceRefs:[]},
      {schoolId:'scut',formats:['暂无可靠来源'],prep:'六份原稿未提供可追溯的华南理工大学面试题条目，等待补充官方流程或可靠回忆。',questions:[],availability:'missing_source',sourceRefs:[]},
      {schoolId:'sdu',formats:['暂无可靠来源'],prep:'六份原稿未提供可追溯的山东大学面试题条目，等待补充官方流程或可靠回忆。',questions:[],availability:'missing_source',sourceRefs:[]}
    ]
  };

  RULES.schools.forEach(school => {
    const verification = school.verification || {};
    const hasOfficialJiangsuPlan = verification.status === 'official_verified'
      && verification.year === RULES.meta.year
      && verification.province === RULES.meta.province
      && Array.isArray(school.jiangsuMajors)
      && school.jiangsuMajors.length > 0;
    school.researchable = school.researchable !== false && verification.status !== 'blocked';
    school.recommendable = hasOfficialJiangsuPlan;
    school.scoreBandSource = '非官方经验占位';
    school.scoreBandUsedForRecommendation = false;
    school.scoreGuidance = '待录入江苏位次/普通批线差；固定裸分不参与推荐';
  });

  RULES.interviews = RULES.interviews.map(entry => {
    const missingSource = entry.availability === 'missing_source';
    return {
      ...entry,
      kind: missingSource ? 'missing_source' : 'training_adaptation',
      availability: missingSource ? 'missing_source' : 'training_only',
      sourceRefs: entry.sourceRefs || ['source-interview'],
      notice: missingSource
        ? '暂无可追溯题目：不生成、不借用其他学校题目，待补可靠来源。'
        : INTERVIEW_TRAINING_NOTICE
    };
  });

  window.STRONG_BASE_RULES_2026 = RULES;
})();
